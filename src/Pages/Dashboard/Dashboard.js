        ...
        <div className={classes.card1}>
          ...
          <div className={classes.profile}>
            <div className={classes.photo}>
              <img alt="sorry, something is broken" className={classes.img} src={profileDetails.data.photo}></img>
            </div>
          ...
          <div className={classes.buttons}>
            <div className={classes.link}>
              <Link className={classes.linkText} to={"/update-profile"}>Update profile</Link>
            </div>
            <div className={classes.link}>
