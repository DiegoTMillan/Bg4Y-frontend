              ...
              {user.data.info[0].role === "admin" && (
                <div className={` ${classes.modLogo}`}>
                  <Link className={classes.linkText1} to={"/users"}>
                    <i
                      className={`${classes.iconTools} fa-solid fa-toolbox`}
                    ></i>
                    <h1>ADMIN</h1>
                  </Link>
                </div>
          ...
          <div className={classes.card1}>
            ...
            <div className={classes.profile}>
              <div className={classes.photo}>
                <img
                  alt="sorry, something is broken"
                  src={user.info[0].photo}
                ></img>
              </div>
              <div className={classes.titleName}>
                <h1>
                  {user.info[0].first_name} {user.data.info[0].last_name}
                </h1>
              </div>
              <div className={classes.columns}>
                <div className={classes.column1}>
                  <div className={classes.email}>
                    <i className={"fa-solid fa-envelope"}></i>
                    <p>{user.info[0].email}</p>
                  </div>
                  <div className={classes.phone}>
                    <i className={"fa-solid fa-phone"}></i>
                    <p>{user.info[0].phone}</p>
                  </div>
                </div>
                <div className={classes.column2}>
                  <div className={classes.city}>
                    <i className={"fa-solid fa-city"}></i>{" "}
                    <p>{user.info[0].city}</p>
                  </div>
                  <div className={classes.district}>
                    <i className={"fa-solid fa-earth-oceania"}></i>
                    <p>{user.info[0].district}</p>
                  </div>
                </div>
              </div>
            </div>
            <div className={classes.games}>
              <i className="fa-solid fa-dice-six"></i>
              <p>{user.info[0].game_name.join("/ ")}</p>
            </div>
            <div className={classes.buttons}>
              <div className={classes.link}>
                <Link className={classes.linkText} to={"/update-profile"}>
